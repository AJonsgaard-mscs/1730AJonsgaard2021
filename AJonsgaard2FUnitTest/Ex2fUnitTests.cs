...
using AJonsgaard2F_if_if_else;

namespace AJonsgaard2FUnitTest
{
    [TestClass]
    public class Ex2fUnitTests
    {
        ...
        {
            Assert.AreEqual("Invalid Input", Ex2fCalculations.Calc10("1", ""));
        }
        [TestMethod]
        public void Test10InputA0()
        {
            Assert.AreEqual("Invalid Input", Ex2fCalculations.Calc10("0", "2"));
        }
        [TestMethod]
